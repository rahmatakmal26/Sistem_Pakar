                  ...
                  <div class="container" style="margin: 15px 5px 15px 0;">
                    ...
                    $sql = mysqli_query($koneksi, $query);
                      while ($row = mysqli_fetch_array($sql)) {
                        echo "<h1>Selamat Datang di Halamanan Admin SISTEM PAKAR</h1>";
                      }
                    ?>
                    <h3>Sistem yang akan berfungsi untuk membantu para petani dalam mendiagnosa Penyakit Pada Tanaman Cabai Merah</h3>
                  </div>
                </div>
              </div>
            </div>
